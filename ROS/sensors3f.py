...
from robotiq_s_model_control.msg import _SModel_robot_input as gripperIn
...
class Sensors3:
    def __init__(self):
        ...
        # robotiq gripper
        self.gripper = [gripperIn.SModel_robot_input()]
        ...
        # robotiq gripper
        rospy.Subscriber("/SModelRobotInput", gripperIn.SModel_robot_input, partial(self.updateState_cb, self.gripper))
